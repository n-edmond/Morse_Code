...
//FUNCTIONS
	...
	void display();//to display the tree and possible letters. not sure yet. may call on display_Binary_tree_function?
...
//OVERLOADED FUNCTIONS. decided to make private since there isnt much of a need to mess with these. Might change later?
	...
	void removing_BST(BST_Node *main_root);//same as B_S_T.h erase function.
